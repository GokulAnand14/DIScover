...
export default function Chat() {
  ...
  return (
    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="" className="flex items-center space-x-3 rtl:space-x-reverse">
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">💙DIScover</span>
        </a>
    ...
    <div className="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[14px] rounded-[1rem] h-max max-w-lg m-5">
        <div className="rounded-[1.5rem] overflow-hidden max-w-lg h-max bg-white dark:bg-gray-800">
          {messages.length > 0
          ? messages
